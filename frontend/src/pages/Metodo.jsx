    ...
    <main className="pt-20">
      ...
      <section className="py-24 bg-[#1a1c1b]">
        <div className="max-w-[1400px] mx-auto px-5 md:px-10">
          <div className="max-w-3xl">
            <span className="caption text-[#d9fb06] mb-4 block">Il Nostro Metodo</span>
            <h1 className="heading-1 mb-6">Strategia chiara,<br />risultati misurabili</h1>
            ...
            {methodSteps.map((step, index) => (
              <div key={index} className="relative">
                {index < methodSteps.length - 1 && (
                  <div className="hidden lg:block absolute top-12 left-full w-full h-[2px] bg-[#3f4816]" />
                )}
                <div className="text-6xl font-black text-[#3f4816] mb-4">{step.number}</div>
                <h3 className="text-2xl font-bold text-[#d9fb06] mb-4">{step.title}</h3>
                <p className="text-[#888680]">{step.description}</p>
              </div>
            ))}
          </div>
        </div>
      ...
      <section className="py-24 bg-[#1a1c1b]">
        <div className="max-w-[1400px] mx-auto px-5 md:px-10">
          <div className="text-center mb-16">
            <span className="caption text-[#d9fb06] mb-4 block">Perché sceglierci</span>
            <h2 className="heading-2">Cosa ci distingue</h2>
          </div>
          <div className="grid md:grid-cols-2 gap-8">
            <div className="bg-[#302f2c] p-10 rounded-xl border border-[#3f4816] hover:border-[#d9fb06] transition-colors">
              <div className="w-14 h-14 rounded-xl bg-[#3f4816] flex items-center justify-center mb-6">
                <Eye className="text-[#d9fb06]" size={28} />
              </div>
            ...
            <div className="bg-[#302f2c] p-10 rounded-xl border border-[#3f4816] hover:border-[#d9fb06] transition-colors">
              <div className="w-14 h-14 rounded-xl bg-[#3f4816] flex items-center justify-center mb-6">
                <BarChart3 className="text-[#d9fb06]" size={28} />
              </div>
            ...
            <div className="bg-[#302f2c] p-10 rounded-xl border border-[#3f4816] hover:border-[#d9fb06] transition-colors">
              <div className="w-14 h-14 rounded-xl bg-[#3f4816] flex items-center justify-center mb-6">
                <Shield className="text-[#d9fb06]" size={28} />
              </div>
      ...
      <section className="py-24 bg-[#302f2c]">
        <div className="max-w-[1400px] mx-auto px-5 md:px-10">
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            <div>
              <span className="caption text-[#d9fb06] mb-4 block">Come lavoriamo</span>
              <h2 className="heading-2 mb-8">Un processo<br />collaudato</h2>
              <div className="space-y-6">
                <div className="flex gap-4">
                  <div className="w-8 h-8 rounded-full bg-[#d9fb06] flex items-center justify-center flex-shrink-0 text-[#1a1c1b] font-bold text-sm">
                    1
                  </div>
                  <div>
            ...
            <div className="bg-[#1a1c1b] p-10 rounded-xl border border-[#3f4816]">
              <h3 className="text-2xl font-bold text-[#d9fb06] mb-8">I nostri numeri</h3>
      ...
      <section className="py-24 bg-[#1a1c1b]">
        <div className="max-w-[1400px] mx-auto px-5 md:px-10">
          <div className="max-w-3xl mx-auto text-center">
            <span className="caption text-[#d9fb06] mb-4 block">La nostra promessa</span>
            <h2 className="heading-2 mb-6">Risultati o niente</h2>
            <p className="text-[#888680] text-lg leading-relaxed mb-10">
      ...
      <section className="py-24 bg-[#3f4816]">
        <div className="max-w-[1400px] mx-auto px-5 md:px-10 text-center">
          <h2 className="heading-2 text-white mb-6">Vuoi saperne di più?</h2>
